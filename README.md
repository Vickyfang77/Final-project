...
## Repository Architecture (倉庫資料夾架構)

The workspace is organized according to standardized scientific computing and reproducible data science conventions:

```text
├── data/
│   ├── raw/                # Original survey data source files
│   └── processed/          # Standardized, cleaned dataset (N = 13,019)
├── notebooks/
│   ├── 01_data_check.ipynb # Quality check, filtering, and database cleaning
│   ├── 02_eda.ipynb        # Multi-panel demographic exploratory visualization
│   └── 03_inference.ipynb  # Intersectional OLS linear regression testing
├── outputs/
│   ├── figures/            # Exported academic analytical plot files
│   ├── tables/             # Statistical summary data spreadsheets (CSV)
│   └── summary/            # Executive summary text files
└── references/
    ├── variable_definitions.md  # Detailed operational data dictionary
    └── recoding_rules.md        # Data transformation pipeline logic
